...
function getPlatformWise(params) {
  return new Promise((resolve, reject) => {
    console.log(params);
    Color.findOne({ platform: params.platform, active: true })
      .then((colors) => {
        resolve({ success: true, colors });
      })
      .catch((err) => {
...
function update(req, res) {
  return new Promise((resolve, reject) => {
    ...
    return Color.findByIdAndUpdate(id, { colors: colors, platform: platform })
      .then((res) => {
...
function setActive(req, res) {
  return new Promise((resolve, reject) => {
    ...
    return Color.findByIdAndUpdate(id, { active: true })
      .then((res) => {
        console.log(res);
        resolve({ success: true, message: "Colors updated" });
      })
