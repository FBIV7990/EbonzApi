...
function getConversationById(req, res, next) {
  ...
  conversationService.getConversationById(req.query)
  .then((message) =>
    res.json(
      message      
    )
...
function _delete(req, res, next) {
  ...
  conversationService.delete(req)
  .then((message) =>
    res.json(
      message      
    )
